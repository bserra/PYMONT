...
#        self.df = '%Y-%m-%d_%H-%M-%S.%f'  # For v0.2
        self.df = '%d-%m-%Y_%H-%M-%S'
...
#        layout = pg.graphicsItems.GraphicsLayout()
#        self
...
#        legend_setpoints = pg.LegendItem()
...
#        self.setCentralWidget(self.l)
    ...
    def start_monitoring(self):
        try:
            ...
            self.logtime = datetime.datetime.now().strftime('%d-%m-%Y_%H-%M-%S')+'\t'
...
This program is a simple communication and monitoring interface for the CRISLER
cryostat.
