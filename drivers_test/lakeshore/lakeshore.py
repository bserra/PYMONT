...
import json
import sys
import drivers.pyvisa_connect as pyvisa
...
class LakeShore33x(object):
    ...
    * SETP?: Control setpoint query
    ...
    def __init__(self, **kwargs):
        ...
        kwargs.update({'TERMINATION_STRING':'\r\n'})
        instrument_connexion = pyvisa.connector(kwargs)
        self.instrument, self.inst_id, self.connected = instrument_connexion.connect()
